            ...
            <div class="list-group-item">
                <div class="d-flex">
                    <div class="mr-auto p-2">
                        <h2 class="display-4 titulo">Cadastrar Tipo de área verde</h2>
                    </div>
                ...
                <form action="" method="post" id="form_tipo_areaverde" accept-charset="utf-8" onsubmit="">
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label><span class="text-danger">*</span> Tipo da área:</label>
                            <input type="text" name="nome" class="form-control" value="" placeholder="Ex. Parque">
                        </div>
                    </div>
