            ...
            <ul class="list-unstyled">
                ...
                <li>
                    ...
                    <ul id="submenu1" class="list-unstyled collapse">
                        ...
                        <li><a href="./adicionar.php">Tipo de Área Verde</a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul id="submenu2" class="list-unstyled collapse">
                        ...
                        <li><a href="./listar.php">Tipo de Área Verde</a></li>
                    </ul>
                </li>
                <li>
            ...
            <div class="list-group-item">
                <div class="d-flex">
                    <div class="mr-auto p-2">
                        <h2 class="display-4 titulo">Listar tipo de área verde</h2>
                    </div>
                </div>
                ...
                <div class="alert " role="alert">
					<?php
						...
						if (isset($_GET["id"]) && is_numeric($_GET["id"])) {
							...
							$tipo_areaverde = new TipoAreaverde($_GET["id"]);	
							$tipo_areaverde->excluir();
                        ...
                        <tbody>
                            <?php
                                ...
                                $tipos_areaverde = TipoAreaverde::listar();
                                    ...
                                    {							
                                        echo '<tr><td>'.$tipo_areaverde->getIdtipoAreaverde().'</td>';
                                        echo '<td>'.$tipo_areaverde->getNome().'</td>';	
                                        echo '<td class="d-flex justify-content-center"><a class="mr-2 btn btn-outline-warning btn-sm" href="./editar.php?&id='.$tipo_areaverde->getIdtipoAreaverde().'">Editar</a>';	
                                        echo '<a class="btn btn-outline-danger btn-sm"  class="btn btn-outline-danger btn-sm" href="./excluir.php?&id='.$tipo_areaverde->getIdtipoAreaverde().'">Excluir</a></td></tr>';				
                                    }				
                                } 
                                catch (Exception $e) 
                                {
