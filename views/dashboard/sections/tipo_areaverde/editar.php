...
if (isset($_POST["Salvar"]) && $_POST["Salvar"] === "Salvar") {
	try {
		$tipo_areaverde = new TipoAreaverde($_POST["idtipo_areaverde"]);    
	    $tipo_areaverde->setNome($_POST['nome']); 
		$tipo_areaverde->atualizar();	
	} catch (Exception $e) {
...
<body>
    ...
    <div class="d-flex">
        ...
        <form action="" method="post" accept-charset="utf-8" onsubmit="">
            <input type="hidden" name="idtipo_areaverde" value="<?php echo $tipo_areaverde->getIdtipoAreaverde();?>"
                placeholder="">
            Tipo da área:
            <input type="text" name="nome" value="<?php echo $tipo_areaverde->getNome();?>" placeholder=""><br>
