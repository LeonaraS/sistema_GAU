                                ...
                                try {
                                    $bairros = Bairro::listar();
                                        foreach ($bairros as $bairro) {								
                                            echo '<tr>';
                                            echo'<td>'.$bairro->getIdBairro().'</td>';
                                            echo '<td>'.$bairro->getNome().'</td>';
                                            echo '<td>'.$bairro->getPopulacao().'</td>';
                                            echo '<td>'.$bairro->getZona().'</td>';
                                            echo '<td><a class="mr-2 btn btn-outline-warning btn-sm" href="./editar.php?&id='.$bairro->getIdBairro().'">Editar</a>';	
                                            echo '<a class="btn btn-outline-danger btn-sm" href="./excluir.php?&id='.$bairro->getIdBairro().'">Excluir</a></td>';
                                            echo '</tr>';											
                                        }				
                                    } catch (Exception $e) {
