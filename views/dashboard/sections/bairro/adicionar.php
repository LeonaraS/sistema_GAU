...
?>
                ...
                <!-- Inicio do form -->
                <form  action="" method="post" id="form_bairro" accept-charset="utf-8" onsubmit="">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label><span class="text-danger">*</span> Nome: </label>
                            <input type="text" value="" name="nome" class="form-control" placeholder="">
                        </div>

                        <div class="form-group col-md-6">
                            <label><span class="text-danger">*</span> População:</label>
                            <input type="number" name="populacao" class="form-control" value="" placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="zona" class="form-control">
                            <option value="" name="" checked>Selecione</option>
