...
require './../requires/require.php';
	...
	try {
		$bairro = new Bairro($_POST["idbairro"]);
		$bairro->setNome($_POST['nome']);                             
	    $bairro->setPopulacao($_POST['populacao']);                             
	    $bairro->setZona($_POST['zona']);
		$bairro->atualizar();
	} catch (Exception $e) {
...
<body>
    ...
    <div class="d-flex">
            ...
            <ul class="list-unstyled">
                ...
                <li>
                    ...
                    <ul id="submenu1" class="list-unstyled collapse">
                        ...
                        <li><a href="./adicionar.php">Bairro</a></li>
                ...
                <li>
                    ...
                    <ul id="submenu2" class="list-unstyled collapse">
                        ...
                        <li><a href="./listar.php">Bairro</a></li>
        ...
        <form action="" method="post" accept-charset="utf-8" onsubmit="">
            <input type="hidden" name="idbairro" value="<?php echo $bairro->getIdbairro();?>">
            Nome: <input type="text" name="nome" value="<?php echo $bairro->getNome();?>" placeholder=""><br>
            População: <input type="number" name="populacao" value="<?php echo $bairro->getPopulacao();?>"
                placeholder=""><br>
            Zona: <select name="zona">
                <option value="<?php echo $bairro->getZona();?>" name="zona" checked><?php echo $bairro->getZona()?>
                </option>
                <option value="Norte" name="zona">Norte</option>
                <option value="Sul" name="zona">Sul</option>
                <option value="Oeste" name="zona">Oeste</option>
                <option value="Central" name="zona">Central</option>
            </select><br>
