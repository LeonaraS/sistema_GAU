...
if (isset($_POST["Salvar"]) && $_POST["Salvar"] === "Salvar") {
	try {
		$areaverde = new AreaVerde($_POST["idareaverde"]);
...
<body>
    ...
    <div class="d-flex">
        ...
        <form action="" method="post" accept-charset="utf-8" onsubmit="">
            <input type="hidden" name="idareaverde" value="<?php echo $areaverde->getIdareaverde();?>" placeholder="">
            Tipo da área verde:
            <select name="tipo_areaverde_idtipo_areaverde" class="" value="">
                <?php 
	    	 $tipos_areaverde = TipoAreaverde::listar();
	    	 foreach ($tipos_areaverde as $tipo_areaverde){?>
                <option name="tipo_areaverde_idtipo_areaverde"
                    value="<?php echo $tipo_areaverde->getIdtipoAreaverde();?>"><?php echo $tipo_areaverde->getNome()?>
                </option>
                <?php } ?>
                <option name="tipo_areaverde_idtipo_areaverde" value="1">Tipo 1</option>
                <option name="tipo_areaverde_idtipo_areaverde" value="2">Tipo 2</option>
                <option name="tipo_areaverde_idtipo_areaverde" value="3">Tipo 3</option>
            </select><br>
            ...
            Área em metros:<input type="number" name="area" step=".01" value="<?php echo $areaverde->getArea();?>"><br>
