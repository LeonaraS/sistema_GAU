            ...
            <ul class="list-unstyled">
                ...
                <li>
                    ...
                    <ul id="submenu2" class="list-unstyled collapse">
                        <li><a href="./listar.php">Área Verde</a></li>
            ...
            <div class="list-group-item">
                <div class="d-flex">
                    <div class="mr-auto p-2">
                        <h2 class="display-4 titulo">Listar Área Verde</h2>
                    </div>
                </div>
...
if (isset($_GET["id"]) && is_numeric($_GET["id"])) {
	...
	$areaverde = new Areaverde($_GET["id"]);	
	$areaverde->excluir();
                            ...
                            <?php
                                ...
                                try 
                                {
                                    $areasverdes = AreaVerde::listar();
                                        ...
                                        {
                                            echo '<tr>';
                                                echo '<td>'.$areaverde->getIdareaverde().'</td>';
                                                echo '<td>'.$areaverde->getTipoAreaverdeIdtipoAreaverde().'</td>';
                                                echo '<td>'.$areaverde->getFuncionarioIdFuncionario().'</td>';
                                                echo '<td>'.$areaverde->getArea().'</td>';	
                                                echo '<td class="text-center">';
                                                echo '<span class="d-none d-md-block">';
                                                    echo'<a  class="mr-2 btn btn-outline-warning btn-sm" href="./editar.php?&id='.$areaverde->getIdAreaverde().'">Editar  </a>';	
                                                    echo '<a  class="btn btn-outline-danger btn-sm"   href="./excluir.php?&id='.$areaverde->getIdAreaverde().'">Excluir</a>';
                                                echo'</span>';

                                                echo '<div class="dropdown d-block d-md-none">';
                                                    echo'<button class="btn btn-primary dropdown-toggle btn-sm" type="button" id="acoesListar" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    Ações';
                                                    echo '</button>';
