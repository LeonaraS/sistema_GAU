...
if (isset($_POST["Salvar"]) && $_POST["Salvar"] === "Salvar") {
	...
	try {
		$cidadao = new Cidadao($_POST["idcidadao"]);	
...
<body>
    ...
    <div class="d-flex">
        ...
        <form action="" method="post" accept-charset="utf-8" onsubmit="">
            <input type="hidden" name="idcidadao" value="<?php echo $cidadao->getIdcidadao();?>" placeholder="">
            Nome completo:
            <input type="text" name="nome" value="<?php echo $cidadao->getNome();?>" placeholder=""> <br>

            CPF ou CNPJ:
            <input type="number" name="cpf_cnpj" value="<?php echo $cidadao->getCpfCnpj();?>" placeholder=""> <br>

            RG:
            <input type="text" name="rg" value="<?php echo $cidadao->getRg();?>" placeholder=""> <br>

            Fone fixo:
            <input type="number" name="fone_fixo" value="<?php echo $cidadao->getFoneFixo();?>" placeholder=""> <br>

            Celular:
            <input type="number" name="celular" value="<?php echo $cidadao->getCelular();?>" placeholder=""> <br>

            Email:
            <input type="email" name="email" value="<?php echo $cidadao->getEmail();?>" placeholder=""> <br>

            Senha:
            <input type="password" name="senha" value="<?php echo $cidadao->getSenha();?>"
