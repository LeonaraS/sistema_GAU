...
<body>
    ...
    <div class="d-flex">
        ...
        <form action="" method="post" accept-charset="utf-8" onsubmit="">
            <input type="hidden" name="idmuda" value="<?php echo $muda->getIdmuda();?>">
            Quantidade:
            <input type="number" name="quantidade" value="<?php echo $muda->getQuantidade();?>" placeholder=""><br>
