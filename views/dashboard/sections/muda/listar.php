            ...
            <ul class="list-unstyled">
                ...
                <li>
                    ...
                    <ul id="submenu2" class="list-unstyled collapse">
                        ...
                        <li><a href="./listar.php">Muda</a></li>
            ...
            <div class="list-group-item">
                <div class="d-flex">
                    <div class="mr-auto p-2">
                        <h2 class="display-4 titulo">Listar Mudas</h2>
                    </div>
                </div>
                                ...
                                try {
                                    $mudas = Muda::listar();
                                        foreach ($mudas as $muda) {								
                                            echo '<tr><td>'.$muda->getIdmuda().'</td>';
                                            echo '<td>'.$muda->getFuncionarioIdFuncionario().'</td>';
                                            echo '<td>'.$muda->getQuantidade().'</td>';
                                            echo '<td class="d-flex justify-content-center"><a  class="mr-2 btn btn-outline-warning btn-sm" href="./editar.php?&id='.$muda->getIdmuda().'">Editar</a>';	
                                            echo '<a class="btn btn-outline-danger btn-sm" href="./excluir.php?&id='.$muda->getIdmuda().'">Excluir</a></td></tr>';					
                                        }				
                                    } catch (Exception $e) {
