                                ...
                                try {
                                    $cargos = Cargo::listar();
                                        foreach ($cargos as $cargo) {								
                                            echo '<tr><td>'.$cargo->getIdCargo().'</td>';
                                            echo '<td>'.$cargo->getNome().'</td>';
                                            echo '<td><a class="mr-2 btn btn-outline-warning btn-sm" href="./editar.php?&id='.$cargo->getIdCargo().'">Editar</a>';	
                                            echo '<a  class="btn btn-outline-danger btn-sm"  href="./excluir.php?&id='.$cargo->getIdCargo().'"> Excluir</a></td></tr>';					
                                        }				
                                    } catch (Exception $e) {
