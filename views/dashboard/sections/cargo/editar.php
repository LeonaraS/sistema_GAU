...
<body>
    ...
    <div class="d-flex">
            ...
            <ul class="list-unstyled">
                ...
                <li>
                    ...
                    <ul id="submenu1" class="list-unstyled collapse">
                        ...
                        <!-- <a><a href="./../requerimento/adicionar.php">Requerimento</a></li> -->
                ...
                <li>
                    ...
                    <ul id="submenu2" class="list-unstyled collapse">
                        ...
                        <li><a href="./listar.php">Cargo</a></li>
        ...
        <form action="" method="post" accept-charset="utf-8" onsubmit="">
            <input type="hidden" name="idcargo" value="<?php echo $cargo->getIdcargo();?>" placeholder="">
            Cargo:
            <input type="text" name="nome" value="<?php echo $cargo->getNome();?>" placeholder=""><br>
