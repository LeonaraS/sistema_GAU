                                ...
                                try {
                                    $funcionarios = Funcionario::listar();
                                        foreach ($funcionarios as $funcionario) {								
                                            echo '<tr><td>'.$funcionario->getIdfuncionario().'</td>';
                                            echo '<td>'.$funcionario->getCargoIdcargo().'</td>';
                                            ...
                                            echo '<td>'.date("d-m-Y", strtotime($funcionario->getDataNascto())).'</td>';	
                                            echo '<td><a class="mr-2 btn btn-outline-warning btn-sm" href="./editar.php?&id='.$funcionario->getIdfuncionario().'">Editar</a>';	
                                            echo '<a class="btn btn-outline-danger btn-sm" href="./excluir.php?&id='.$funcionario->getIdfuncionario().'">Excluir</a></td></tr>';		
                                        }				
                                    } catch (Exception $e) {
