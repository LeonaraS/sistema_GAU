            ...
            <div class="list-group-item">
                <div class="d-flex">
                    <div class="mr-auto p-2">
                        <h2 class="display-4 titulo">Listar Projetos</h2>
                    </div>
                </div>
                                ...
                                try {
                                    $projetos = Projeto::listar();
                                        foreach ($projetos as $projeto) {								
                                            echo '<tr><td>'.$projeto->getIdprojeto().'</td>';
                                            echo '<td>'.$projeto->getFuncionarioIdfuncionario().'</td>';
                                            echo '<td>'.$projeto->getTitulo().'</td>';
                                            echo '<td>'.$projeto->getImplantacao().'</td>';								
                                            echo '<td class="text_wrap">'.$projeto->getDescricao().'</td>';								
                                            echo '<td>'.$projeto->getResponsavel().'</td>';	
                                            echo '<td class="d-flex justify-content-center"><a class="mr-2 btn btn-outline-warning btn-sm" href="./editar.php?&id='.$projeto->getIdprojeto().'">Editar</a>';	
                                            echo '<a class="btn btn-outline-danger btn-sm" href="./excluir.php?&id='.$projeto->getIdprojeto().'">Excluir</a></td></tr>';							
                                        }				
                                    } catch (Exception $e) {
