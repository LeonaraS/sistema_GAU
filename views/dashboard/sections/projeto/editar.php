...
if (isset($_POST["Salvar"]) && $_POST["Salvar"] === "Salvar") {
	try {
		$projeto = new Projeto($_POST["idprojeto"]);    
...
<body>
    ...
    <div class="d-flex">
            ...
            <ul class="list-unstyled">
                ...
                <li>
                    ...
                    <ul id="submenu2" class="list-unstyled collapse">
                        ...
                        <li><a href="./listar.php">Projeto</a></li>
        ...
        <form action="" method="post" accept-charset="utf-8" onsubmit="">
            <input type="hidden" name="idprojeto" value="<?php echo $projeto->getIdprojeto();?>" placeholder="">
            ...
            Título do Projeto:<input type="text" name="titulo" value="<?php echo $projeto->getTitulo();?>"
                placeholder=""><br>

            Tempo para implantação:<input type="text" name="implantacao"
                value="<?php echo $projeto->getImplantacao();?>" placeholder="Ex.: 2 semanas"><br>

            Descrição: <textarea name="descricao" value="<?php echo $projeto->getDescricao();?>"
                placeholder=""><?php echo $projeto->getDescricao()?></textarea><br>
            Responsável técnico:<input type="text" name="responsavel" value="<?php echo $projeto->getResponsavel();?>"
                placeholder=""><br>
